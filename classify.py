...
CATEGORIES = [
    "社交通知",    # LinkedIn/social platform notifications — likes, connection requests
    "广告推广",    # marketing, newsletters, promotions
    "财务账单",    # bank/brokerage statements, bills, invoices
    "安全提醒",    # account security alerts, login notifications, fraud warnings
